...
- Fase semi-montada, com um level, inimigos espalhados pela fase;
- Inimigos “olham” para o personagem principal, é feito: rotação e vetor forward deixado apontando: transform.LookAt(transform);
